<div class="space-y-4 my-5 font-serif text-sm">
    ...
    <div class="space-y-4 px-8">
        ...
        <div class="space-y-2">
            ...
            <p class="indent-8">Tersebut di atas adalah warga yang bertempat tinggal di {{ $envelope->value['alamat'] }} dan
                yang bersangkutan hingga saat ini masih tinggal di Desa Bluru dengan Alamat seperti tersebut di atas.
                Adapun Surat Keterangan Domisili ini di buat untuk Keperluan
                {{ trim($envelope->value['keperluan']) }}.</p>
